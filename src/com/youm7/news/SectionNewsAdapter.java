...
public class SectionNewsAdapter extends BaseAdapter implements TaskCompletedListener {
	...
	.cacheOnDisc(true)
	.build(); 
	static DisplayImageOptions dispoptions1= new DisplayImageOptions.Builder()
...
public int getViewTypeCount() {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((Youm7TextView) (mNewsBlock.findViewById(R.id.sec_news_date))).setText(mNewslist.get(position).NewsDateString);
	
		try {
			mUniversalimageloader.displayImage(mNewslist.get(position).NewsImgLink.replace("/large/", "/medium/"),  ( (ImageView) (mNewsBlock.findViewById(R.id.newsimageview))),dispoptions1);
		} catch (NullPointerException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			mNewsBlock.findViewById(R.id.newsimageview).setVisibility(View.GONE);
			mNewsBlock.findViewById(R.id.news_abstract_textview).setVisibility(View.GONE);	
		}
	 	return mNewsBlock;
			}
			else 
		...
		{
		try {
			mUniversalimageloader.displayImage(mNewslist.get(position).NewsImgLink.replace("/large/", "/medium/"),  ( (ImageView) (convertView.findViewById(R.id.newsimageview))),dispoptions1);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			mNewsBlock.findViewById(R.id.news_abstract_textview).setVisibility(View.GONE);	
